...
def filter_data(data2D, errs2D):
    ...
    errs2D[if np.isfinite(errs2D) == False] = 0.0
    data2D[if np.isfinite(errs2D) == False] = 0.0
    data2D[if np.isfinite(data2D) == False] = 0.0
    errs2D[if np.isfinite(data2D) == False] = 0.0
