...
def plot_fitted_spatial_profile(
    spatial_axis, bin_data, hiresspataxis, binmoffparams, imgstart, headparams
):
    """
    ...
    plt.plot(spatial_axis + imgstart, bin_data, color="k", label="Spatial Profile")
