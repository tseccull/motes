...
As shown in `instrumentio.py`, an instrument I/O module contains two
functions. The harvester function, and the save function. Descriptions
of these functions and how to set them up for your instrument follow.

Don't forget to alter the docstring at the top of your copied 
